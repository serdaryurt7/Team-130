...
public class C07_BinarySearch {
    public static void main(String[] args) {
        ...
        // sort işlemi yapılmadan binarySearch kullanılırsa sonuç ÖNGÖRÜLEMEZ, doğru da olabilir yanlış da olabilir
        ...
        // olmayan sayılarda OLMADIĞINI belirtmek için eksi (-) kullanılır
        // -0 anlamsız olacağından, olmayan elementlerin yerlerini SIRA olarak verir
