...
public class C01_IndexOf {
    public static void main(String[] args) {
        ...
        // ikinci space' in indexini yazın

        System.out.println(str.indexOf(" ", 4 + 1)); // space' ten sonraki index seçilmeli 4. de boşluk var 5. index

        // ikinci i'nin index'ini yazdirin

        System.out.println(str.indexOf("i")); // 16

        System.out.println(str.indexOf("i", 17)); // dinamik değil   // 32
        ...
        if (ilkCindex == -1) {
            ...
            System.out.println("Verilen metinde 2. 'c' yok");
        }else {
            System.out.println("Verilen metinde 2. 'c' var");
        }
