...
public class C05_MapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // harfler.put("M", 30);
        // eğer replace yapılmak istenen key, map'de var ise
        // replace ile put aynı işlevi görür
        // eğer replace yapılmak isetenen keyi map'de yok ise
        // replace null döndürür ve map'e eklemez, put ise her durumda ekler
