...
public class C06_NestedMap {
    ...
    public static void main(String[] args) {
        ...
        // 102 numaralı öğrencinin soyadini yazdirin

        System.out.println(ogrenciMap.get(102).get("Soyisim")); // Cem

        // 103 numaralı öğrencinin sınıfını 12 yapın

        ogrenciMap.get(103).put("Sinif", "12");

        // 102 numaralı öğrencinin bölümünü yazdırın

        System.out.println(ogrenciMap.get(102).get("Bolum")); // TM

        // 102 numarali öğrencinin bölümünü MF yapın
